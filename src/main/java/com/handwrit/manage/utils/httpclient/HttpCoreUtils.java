package com.handwrit.manage.utils.httpclient;
...
public class HttpCoreUtils {
    ...
    public static String httpPostRequest(String url, Map<String, Object> params)
        ...
        HttpPost httpPost = new HttpPost(url);
        ArrayList<NameValuePair> pairs = covertParams3NVPS(params);
    ...
    private static ArrayList<NameValuePair> covertParams3NVPS(Map<String, Object> params) {
